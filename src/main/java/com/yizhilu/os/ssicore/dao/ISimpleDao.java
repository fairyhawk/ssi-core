...
/**
 * 简单crud操作共用dao接口 User: guoqiang.liu Date: 2008-11-29 Time: 0:44:25 To change
...
public interface ISimpleDao {
    ...
    public void batchExecuteSingleSql(String xmlId, List parList, String methodType,
            int countToBeExecute);
